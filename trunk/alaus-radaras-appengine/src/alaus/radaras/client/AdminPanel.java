...
public class AdminPanel implements EntryPoint {
	 ...
	 */
	private static final List<Contact> CONTACTS = new ArrayList<AdminPanel.Contact>(Arrays.asList(new Contact("John", new Date(80, 4, 12), "123 Fourth Avenue"), new Contact("Joe", new Date(85, 2, 22),
			"22 Lance Ln"), new Contact("George", new Date(46, 6, 6), "1600 Pennsylvania Avenue")));
	...
	public void onModuleLoad() {
		...
		TextColumn<Contact> numberColumn = new TextColumn<Contact>() {
			...
			public String getValue(Contact object) {
				return String.valueOf(CONTACTS.indexOf(object));
			}
		};
		table.addColumn(numberColumn, "Nr.");
		
		Column<Contact, Boolean> check = new Column<AdminPanel.Contact, Boolean>(new CheckboxCell()) {
		...
		CONTACTS.add(new Contact("name", new Date(), "address"));
		table.setRowCount(CONTACTS.size(), true);
